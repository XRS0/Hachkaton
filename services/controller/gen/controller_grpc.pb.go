...
type StringServiceClient interface {
	SendString(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*StringReply, error)
}
...
func (c *stringServiceClient) SendString(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (*StringReply, error) {
	out := new(StringReply)
	err := c.cc.Invoke(ctx, "/example.StringService/SendString", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StringServiceServer interface {
	SendString(context.Context, *StringRequest) (*StringReply, error)
...
func (UnimplementedStringServiceServer) SendString(context.Context, *StringRequest) (*StringReply, error) {
...
func _StringService_SendString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.StringService/SendString",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StringServiceServer).SendString(ctx, req.(*StringRequest))
	}
